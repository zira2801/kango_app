...
//
//     final dataFoodOfStoreModel = dataFoodOfStoreModelFromJson(jsonString);

import 'dart:convert';

OrderPickUpListShipperModel dataFoodOfStoreModelFromJson(String str) =>
    OrderPickUpListShipperModel.fromJson(json.decode(str));

String dataFoodOfStoreModelToJson(OrderPickUpListShipperModel data) =>
    json.encode(data.toJson());

class OrderPickUpListShipperModel {
  int status;
  OrdersPickupShipper ordersPickupShipper;
  bool isEdit;

  OrderPickUpListShipperModel({
    required this.status,
    required this.ordersPickupShipper,
    required this.isEdit,
  });

  factory OrderPickUpListShipperModel.fromJson(Map<String, dynamic> json) =>
      OrderPickUpListShipperModel(
        status: json["status"],
        ordersPickupShipper:
            OrdersPickupShipper.fromJson(json["orders_pickup"]),
        isEdit: json["is_edit"],
      );

  Map<String, dynamic> toJson() => {
        "status": status,
        "orders_pickup": ordersPickupShipper.toJson(),
        "is_edit": isEdit,
      };
}

class OrdersPickupShipper {
  int currentPage;
  ...
  factory OrdersPickupShipper.fromJson(Map<String, dynamic> json) =>
      OrdersPickupShipper(
        currentPage: json["current_page"],
        data: List<OrdersPickupShipperItemData>.from(
            json["data"].map((x) => OrdersPickupShipperItemData.fromJson(x))),
      );
...
class OrdersPickupShipperItemData {
  int orderPickupId;
  int userId;
  ...
  String orderPickupDateTimeMethod;
  ...
  String createdAt;
  String updatedAt;
  String? orderPickupStatusLabel;
  Branch branch;
  Shipper user;
  Shipper shipper;

  OrdersPickupShipperItemData({
    ...
    required this.orderPickupStatusLabel,
    required this.branch,
    required this.user,
    required this.shipper,
  });

  factory OrdersPickupShipperItemData.fromJson(Map<String, dynamic> json) =>
      OrdersPickupShipperItemData(
        ...
        userReceiverId: json["user_receiver_id"] ?? 0,
        ...
        orderPickupStatusLabel: json["order_pickup_status_label"],
        branch: Branch.fromJson(json["branch"]),
        user: Shipper.fromJson(json["user"]),
  ...
  Map<String, dynamic> toJson() => {
        ...
        "order_pickup_status_label": orderPickupStatusLabel,
