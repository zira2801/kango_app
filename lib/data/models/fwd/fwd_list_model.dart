...
//
//     final fwdListModel = fwdListModelFromJson(jsonString);

import 'dart:convert';

FwdListModel fwdListModelFromJson(String str) =>
    FwdListModel.fromJson(json.decode(str));

String fwdListModelToJson(FwdListModel data) => json.encode(data.toJson());
...
class FwdListModel {
  ...
  factory FwdListModel.fromJson(Map<String, dynamic> json) => FwdListModel(
        status: json["status"],
...
class Data {
  ...
  factory Data.fromJson(Map<String, dynamic> json) => Data(
        ...
        data: List<FWdItemData>.from(
            json["data"].map((x) => FWdItemData.fromJson(x))),
      );
...
class FWdItemData {
  ...
  factory FWdItemData.fromJson(Map<String, dynamic> json) => FWdItemData(
        userId: json["user_id"],
