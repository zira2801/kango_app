...
class RechargeCashScreen extends StatefulWidget {
  const RechargeCashScreen({super.key});

  @override
  State<RechargeCashScreen> createState() => _RechargeCashScreenState();
}

class _RechargeCashScreenState extends State<RechargeCashScreen> {
