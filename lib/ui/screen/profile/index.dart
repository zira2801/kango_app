...
import 'package:scan_barcode_app/ui/screen/profile/test_scan_image_to_text.dart';
import 'package:scan_barcode_app/ui/screen/recharge/selected_method_screen.dart';
import 'package:scan_barcode_app/ui/screen/scan_code/create_scan_code.dart';
...
class _ProfileUserScreenState extends State<ProfileUserScreen> {
  ...
  final List<void Function(BuildContext)> menuMyAccountActions = [
    ...
    (context) {
      ...
      print("Shipping Preferences tapped");
      // Navigator.push(
      //   context,
      //   MaterialPageRoute(builder: (context) => TestScanImageToText()),
      // );
    },
    (context) {
    ...
    (context) {
      Navigator.push(
        context,
        MaterialPageRoute(builder: (context) => SelectedMethodRechargeScreen()),
      );
    },
    (context) {
    ...
    // },
    // (context) {
    //   // Action for "CreateBarCode"
    //   print("Create BarCode");
    //   Navigator.push(
    //     context,
    //     MaterialPageRoute(builder: (context) => const CreateScanCode()),
    //   );
    // },
    (context) {
      // Action for "Face ID"
                ...
                child: SingleChildScrollView(
                  child: Column(
                    ...
                    children: [
                      ...
                      // ListView.builder(
                      //   physics: const NeverScrollableScrollPhysics(),
                      //   itemCount: menuGeneralTitle.length,
                      //   shrinkWrap: true,
                      //   itemBuilder: (context, index) {
                      //     return InkWell(
                      //       onTap: () {},
