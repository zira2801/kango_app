...
class MenuScanShipperScreen extends StatefulWidget {
  const MenuScanShipperScreen({super.key});

  @override
  State<MenuScanShipperScreen> createState() => _MenuScanShipperScreenState();
}

class _MenuScanShipperScreenState extends State<MenuScanShipperScreen> {
